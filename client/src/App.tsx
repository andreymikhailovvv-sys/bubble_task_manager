          ...
          <div className="focus-mode-shell grid h-[min(820px,calc(100vh-32px))] w-full max-w-6xl grid-cols-[280px_minmax(0,1fr)] overflow-hidden rounded-3xl border shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <section className="flex min-h-0 flex-col p-5">
              ...
              <div className="ai-chat-thread-wrap relative mt-1 min-h-0 flex-1">
                <CustomSelect value={selectedAiChatModel} options={AI_CHAT_MODEL_SELECT_OPTIONS} onChange={(value) => setSelectedAiChatModel(value as AiChatModel)} className="ai-chat-model-cap absolute left-1/2 top-0 z-10 w-40 -translate-x-1/2" buttonClassName="ai-chat-model-cap-button rounded-b-xl rounded-t-none border px-3 py-1.5 text-xs font-semibold text-primary shadow-sm backdrop-blur hover:brightness-105" menuClassName="ai-chat-model-cap-menu surface-popover text-primary" ariaLabel="Выбрать модель чата" />
